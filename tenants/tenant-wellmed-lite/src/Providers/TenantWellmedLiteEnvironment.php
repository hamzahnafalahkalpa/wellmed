...
abstract class TenantWellmedLiteEnvironment extends BaseServiceProvider{
    protected $__config_tenant_wellmed_lite = [];
    ...
    public function __construct(Container $app) {
        ...
        $this->__config_tenant_wellmed_lite = $this->__config['tenant-wellmed-lite'];
    }
