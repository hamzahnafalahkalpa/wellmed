...
namespace WellmedLite\TenantWellmedLite\Commands;
...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tenant-wellmed-lite:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the TenantWellmedLite project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for TenantWellmedLite project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('tenantwellmedlite:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
