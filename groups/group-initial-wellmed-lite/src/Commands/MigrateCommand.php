...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'group-initial-wellmed-lite:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the GroupInitialWellmedLite project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for GroupInitialWellmedLite project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('groupinitialwellmedlite:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
