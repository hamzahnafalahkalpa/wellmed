...
abstract class GroupInitialWellmedLiteEnvironment extends BaseServiceProvider{
    protected $__config_group_initial_wellmed_lite = [];
    ...
    public function __construct(Container $app) {
        ...
        $this->__config_group_initial_wellmed_lite = $this->__config['group-initial-wellmed-lite'];
    }
