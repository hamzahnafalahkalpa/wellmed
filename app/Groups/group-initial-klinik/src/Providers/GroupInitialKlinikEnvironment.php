...
abstract class GroupInitialKlinikEnvironment extends BaseServiceProvider{
    protected $__config_group_initial_klinik = [];
    ...
    public function __construct(Container $app) {
        ...
        $this->__config_group_initial_klinik = $this->__config['group-initial-klinik'];
    }
