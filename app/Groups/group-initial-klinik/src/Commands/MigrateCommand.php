...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'group-initial-klinik:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the GroupInitialKlinik project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for GroupInitialKlinik project have been successfully executed.");

        if ($this->option('seed')){
            $this->info("Run seeding");
            Artisan::call('groupinitialklinik:seed');
            $this->info("Seeded");
        }
        return Command::SUCCESS;
    }
